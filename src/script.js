...
//                 THREE.PerspectiveCamera(field of view, aspect ratio, near clipping plane, far clipping plane) only objects within clipping planes will be rendered, others will be 'clipped'
